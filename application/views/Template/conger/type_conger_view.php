...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">Types de congés : </h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 grid-margin">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modal_type" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog mt-4">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Nouveau Types de conger</h5>
                                    ...
                                    <form action="" method="post" id="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom" id="nom" class="form-control"
                                                placeholder="Nom du type" value="<?= set_value('nom');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control"
                                                ...
                                                <option value="Indisposé">Indisposé</option>
                                            </select>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="add_type">Ajouter</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form action="" method="post" id="edit_form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="edit_nom" id="edit_nom" class="form-control"
                                                placeholder="Nom" value="<?= set_value('edit_nom');?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Status : </label>
                                            <select name="edit_status" id="edit_status" class="form-control"
                                                value="<?= set_value('edit_status');?>">
                                                <option value="">...</option>
                                                <option value="Ouvert">Ouvert</option>
                                                <option value="Indisposé">Indisposé</option>
                                            </select>
        ...
        $(document).on('click', '#add_type', function(e) {
            ...
            $.ajax({
                url: "<?php base_url(); ?>add_type_conger",
                type: "post",
                dataType: "json",
                data: {
                    nom: nom,
                    ...
                    $('#records').DataTable({
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row, meta) {
                                    var a = `
                                        <a href="#" value="${row.type_id}" id="edit" class="btn btn-sm btn-outline-success"><i class="fas fa-edit"></i></a>
                                        <a href="#" value="${row.type_id}" id="del" class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></a>
                                    `;
                                    return a;
                                }
                            }
        ...
        $(document).on('click', '#del', function(e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?= base_url(); ?>delete_type_conger",
                        type: "post",
                        dataType: "json",
                        data: {
                            del_id: del_id
        ...
        $(document).on('click', '#edit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#edit_id').val(data.posts.type_id);
        ...
        $(document).on('click', '#modif', function(e) {
            ...
            $.ajax({
                url: "<?= base_url(); ?>update_type_conger",
                type: "post",
                dataType: "json",
                data: {
                    edit_id: edit_id,
